...
# Configuration
APP_RESOURCE_GROUP="research-report-app-rg-llmops"
LOCATION="eastus"
APP_ACR_NAME="researchreportacrllmops"
CONTAINER_ENV="research-report-env-llmops"
# Generate unique storage account name (max 24 chars, lowercase, alphanumeric only)
STORAGE_ACCOUNT="reportapp$(date +%s | tail -c 7)"
FILE_SHARE="generated-reports-llmops"
