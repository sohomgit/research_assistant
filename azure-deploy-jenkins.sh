...
LOCATION="eastus"
STORAGE_ACCOUNT="reportjenkinsstorellmops"
FILE_SHARE="jenkins-data-llmops"
ACR_NAME="reportjenkinsacrllmops"
CONTAINER_NAME="jenkins-research-report-llmops"
DNS_NAME_LABEL="jenkins-research-$(date +%s | tail -c 6)"
JENKINS_IMAGE_NAME="custom-jenkins-llmops"
